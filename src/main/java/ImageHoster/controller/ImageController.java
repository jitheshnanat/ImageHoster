...
public class ImageController {
   ...
   *     The logic is to get the image from the database with corresponding title. After getting the image from the database
...
/** This controller method is called when the request pattern is of type 'editImage'
    ...
    The method first needs to convert the list of all the tags to a string containing all the tags separated by a comma and then
    add this string in a Model type object
    ...
    The method converts the string to a list of all the tags using findOrCreateTags() method and sets the tags attribute of an image
     as a list of all the tags*/
   ...
   /** findOrCreateTags() method has been implemented, which returns the list of tags after converting the ‘tags’ string to a list of all the
    * tags and also stores the tags in the database if they do not exist in the database. Observe the method and complete the code where
    * required for this method.
    Try to get the tag from the database using getTagByName() method. If tag is returned, you need not to store that tag in the database,
    ...
    /**The method receives the list of all tags Converts the list of all tags to a single string containing all the
      tags separated by a comma Returns the string*/
